-- Entry point for the MiniHealthNumbers test suite. Run from the repository root:
--
...
io.write("MiniHealthNumbers - unit tests\n")
io.write("======================================\n")

local testFiles = {
	"tests/TestCombatLogParser.lua",
	"tests/TestHealthTracker.lua",
