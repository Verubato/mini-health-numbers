...
local function OnCombatLog()
	...
	-- Auto-bind common tokens so pending inference event can be created
	if UnitExists("target") and UnitGUID("target") == dstGUID then
		BindUnit(state, "target")
	elseif UnitExists("focus") and UnitGUID("focus") == dstGUID then
		BindUnit(state, "focus")
	end
